...
\textbf{Initiation Interval (II) of 8} --- one new hash every eight cycles
...
\begin{table}[h]
	...
	\begin{tabular}{@{}lccc@{}}
		\toprule
			...
			Loop pipelining            & $\sim$20 cycles       & $\sim$8     & $\sim$12.5 MH/s     \\
			Pipeline + array partition & $\sim$10 cycles       & $\sim$8     & $\sim$12.5 MH/s     \\
			\bottomrule
		\end{tabular}
	\end{table}

\noindent (At 100 MHz clock, II=8 yields $\sim$12.5 million hashes/second.)
