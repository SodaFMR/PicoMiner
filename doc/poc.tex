...
\begin{table}[h]
	...
	\begin{tabular}{@{}lccc@{}}
		...
		\midrule
		Baseline (no directives)   & $\sim$20 cycles       & $\sim$20    & $\sim$2 MH/s        \\
		Loop pipelining            & $\sim$20 cycles       & $\sim$1     & $\sim$40 MH/s       \\
		Pipeline + array partition & $\sim$10 cycles       & $\sim$1     & $\sim$40 MH/s       \\
		\bottomrule
	\end{tabular}
\end{table}

\noindent (At 40 MHz clock, II=1 yields $\sim$40 million hashes/second.)
