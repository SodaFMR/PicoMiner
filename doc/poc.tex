...
\textbf{Initiation Interval (II) of 4} --- one new hash every four cycles
...
\begin{table}[h]
	...
	\begin{tabular}{@{}lccc@{}}
		\toprule
			...
			Loop pipelining            & $\sim$20 cycles       & $\sim$4     & $\sim$25 MH/s       \\
			Pipeline + array partition & $\sim$10 cycles       & $\sim$4     & $\sim$25 MH/s       \\
			\bottomrule
		\end{tabular}
	\end{table}

\noindent (At 100 MHz clock, II=4 yields $\sim$25 million hashes/second.)
